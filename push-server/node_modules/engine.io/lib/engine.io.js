 ...
 * @api public
 */
//engin.io的Server对象有两种方法生成 require('engine.io')(httpServer); require('engine.io').attach(httpServer);,两种方法是等价的
exports = module.exports = function() {
  ...
  // if first argument is not an http server, then just make a regular eio server //什么是regular eio server
