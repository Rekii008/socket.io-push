 ...
 * @api private
 */
//只在Namespace的add方法中成功新建本socket实例时,调用。是直接调用的,而非通过向本socket emit事件。因为这里没有监听任何事件。
Socket.prototype.onconnect = function () {
    debug('socket connected - writing packet');
    this.nsp.connected[this.id] = this;
    this.join(this.id);     //默认加入socket.id这个room
    this.packet({type: parser.CONNECT});  //回应客户端这个连接namespace的消息,至此,连接过程完成!!!
};
